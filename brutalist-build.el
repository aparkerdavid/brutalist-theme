...
(defun brutalist-build-custom-theme (theme-name)
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-keyword-name-face ((t (:foreground ,fg :underline nil))))
   ...
   `(org-level-3 ((t (:inherit variable-pitch :foreground ,fg :height 1.25 :overline ,bg))))
   ...
   ;; parens - other
   `(sp-show-pair-match-face ((t (:weight bold :slant italic))))
