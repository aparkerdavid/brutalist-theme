...
(defun brutalist-build-custom-theme (theme-name)
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-constant-face ((t (:foreground ,fg :slant italic))))
   ...
   `(org-level-1 ((t (:foreground ,fg :height 1.95 :family variable-pitch))))
   `(org-level-2 ((t (:foreground ,fg :height 1.65 :overline ,bg :family variable-pitch))))
   `(org-level-3 ((t (:foreground ,fg :height 1.25 :overline ,bg :family variable-pitch))))
