...
(defun brutalist-build-custom-theme (theme-name)
  ...
  (custom-theme-set-faces
   ...
   `(org-level-1 ((t (:foreground ,fg :height 1.95 :family "Linux Biolinum"))))
   `(org-level-2 ((t (:foreground ,fg :height 1.65 :overline ,bg :family "Linux Biolinum"))))
